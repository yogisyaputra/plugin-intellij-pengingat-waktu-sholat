        ...
        val html = JEditorPane(
            ...
            <html>
              ...
              <body>
                ...
                <ul>
                  <li>Ambil jadwal sholat dari API eksternal (AlAdhan)</li>
                  <li>Pengingat X menit sebelum adzan (multi-offset)</li>
                  <li>Status bar countdown + ikon dinamis</li>
                  <li>Popup detail hari ini (Refresh now, Settings)</li>
                  <li>Tool Window (sidebar) untuk ubah City/Offset tanpa buka Settings</li>
                  <li>City Picker searchable (10 hasil awal)</li>
                  <li>Mode countdown: ke <b>Adzan</b> / ke <b>Reminder</b></li>
                </ul>
              </body>
            </html>
        """.trimIndent()
